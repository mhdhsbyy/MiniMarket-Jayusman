...
class TransactionMonitoringController extends Controller
{
    ...
    public function pdf(Request $request)
    {
        ...
        return $pdf->stream('Laporan Transaksi Mini Market Jayusmart.pdf');
    }
    ...
    public function excel(Request $request)
    {
        ...
        return Excel::download(
            new TransactionsExport($transactions, $periode, $branch),
            'Laporan Transaksi Mini Market Jayusmart.xlsx'
        );
    }
}
