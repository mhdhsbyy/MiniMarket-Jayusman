        ...
        request()->routeIs('owner.suppliers.*')
            ...
            {{ request()->routeIs('owner.suppliers.*')
                ...
                <div x-data="{ open: false }" class="relative">
                    <button @click="open = ! open"
                        class="px-5 py-2.5 rounded-full text-sm font-bold transition
                        {{ request()->routeIs('owner.monitoring-transaksi') || request()->routeIs('owner.monitoring-stok')
                            ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-500/30'
                            : 'text-slate-300 hover:text-white hover:bg-white/10' }}">
                        Monitoring ▾
                    </button>
                    ...
                    <div x-show="open" x-transition @click.away="open = false"
                        class="absolute left-0 mt-3 w-64 bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden z-50">
                ...
                <div x-data="{ open: false }" class="relative">
                    <button @click="open = ! open"
                        class="px-5 py-2.5 rounded-full text-sm font-bold transition
                        {{ request()->routeIs('owner.laporan-penjualan') || request()->routeIs('owner.laporan-stok')
                            ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-500/30'
                            : 'text-slate-300 hover:text-white hover:bg-white/10' }}">
                        Laporan ▾
                    </button>
