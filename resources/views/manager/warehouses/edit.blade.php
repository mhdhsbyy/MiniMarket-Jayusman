        ...
        <div class="max-w-4xl mx-auto px-6 py-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-slate-500 mt-2">
                    Perbarui akun pegawai gudang untuk cabang yang Anda kelola.
                </p>
            </div>
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="first_name"
                                    value="{{ old('first_name', $warehouse->first_name) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="last_name"
                                    value="{{ old('last_name', $warehouse->last_name) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="username"
                                value="{{ old('username', $warehouse->username) }}"
                                placeholder="Contoh: gudang_cianjur"
                                class="w-full rounded-2xl border-slate-200 bg-slate-50 px-4 py-3 focus:border-emerald-500 focus:ring-emerald-500">
                        ...
                        <div>
                            ...
                            <input type="email" name="email"
                                ...
                                placeholder="Contoh: gudang@gmail.com"
                                class="w-full rounded-2xl border-slate-200 bg-slate-50 px-4 py-3 focus:border-emerald-500 focus:ring-emerald-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="no_hp"
                                value="{{ old('no_hp', $warehouse->no_hp) }}"
