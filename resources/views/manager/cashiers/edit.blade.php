        ...
        <div class="max-w-4xl mx-auto px-6 py-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-slate-500 mt-2">
                    Perbarui akun kasir untuk cabang yang Anda kelola.
                </p>
            </div>

            <div class="bg-white rounded-[2rem] border border-slate-200 shadow-sm overflow-hidden">
                <form action="{{ route('manager.cashiers.update', $cashier->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="first_name"
                                    value="{{ old('first_name', $cashier->first_name) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="last_name"
                                    value="{{ old('last_name', $cashier->last_name) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="username"
                                ...
                                placeholder="Contoh: kasir_cianjur"
                                class="w-full rounded-2xl border-slate-200 bg-slate-50 px-4 py-3 focus:border-emerald-500 focus:ring-emerald-500">
                        ...
                        <div>
                            ...
                            <input type="email" name="email"
                                ...
                                placeholder="Contoh: kasir@gmail.com"
                                class="w-full rounded-2xl border-slate-200 bg-slate-50 px-4 py-3 focus:border-emerald-500 focus:ring-emerald-500">
                        ...
                        <div>
                            ...
                            <select name="status"
                                class="w-full rounded-2xl border-slate-200 bg-slate-50 px-4 py-3 focus:border-emerald-500 focus:ring-emerald-500">
                                <option value="active"
                                    {{ old('status', $cashier->status) == 'active' ? 'selected' : '' }}>
                                    Aktif
                                </option>

                                <option value="inactive"
                                    {{ old('status', $cashier->status) == 'inactive' ? 'selected' : '' }}>
                                    Nonaktif
                                </option>
                            </select>
